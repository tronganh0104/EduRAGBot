...
import { Send, Bot, User, Cpu, Sparkles, Zap, Brain, Sun, Moon, Plus, BookOpen } from "lucide-react"
...
export default function ProfessionalChat() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800 flex flex-col">
      {/* Header */}
      <header className="border-b border-slate-200/60 dark:border-slate-800/60 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl z-50 flex-shrink-0">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Select value={selectedModel} onValueChange={setSelectedModel} disabled={isLoading}>
                <SelectTrigger className="w-56 bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {AI_MODELS.map((model) => (
          ...
          <div className="flex-1 flex flex-col min-h-0">
            <div className="flex-1 overflow-hidden">
              <div
                ...
                className="h-full overflow-y-auto p-6 space-y-6 scroll-smooth scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-600 scrollbar-track-transparent"
              >
                {messages.length === 0 && (
                  <div className="flex items-center justify-center h-full">
                    <div className="text-center max-w-md mx-auto">
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                        Tôi là trợ lý AI chuyên về quy chế đào tạo. Hãy đặt câu hỏi để tôi có thể hỗ trợ bạn tốt nhất.
                      </p>
                    </div>
                  </div>
                )}
                ...
                {/* This div acts as the scroll target - positioned at the very end */}
            ...
            <div className="border-t border-slate-200 dark:border-slate-700 p-6 bg-slate-50/50 dark:bg-slate-800/50 flex-shrink-0">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
                  <span>Nhấn Enter để gửi • {messages.length} tin nhắn</span>
                  <div className="flex items-center space-x-2">
